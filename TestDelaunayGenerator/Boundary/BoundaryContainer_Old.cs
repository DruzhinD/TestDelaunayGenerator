...
namespace TestDelaunayGenerator.Boundary
{
    ...
    /// </summary>
    public class BoundaryContainer_Old
    {
        ...
        public BoundaryContainer_Old(IGeneratorBase generator)
        {
        ...
        public static BoundaryContainer_Old CreateWithBoundary(IHPoint[] boundary, IGeneratorBase generator = null)
        {
            ...
            var container = new BoundaryContainer_Old(effectiveGenerator);
